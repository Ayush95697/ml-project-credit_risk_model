...
from prediction_helper1 import predicte  # Ensure this is correctly linked to your prediction_helper.py
...
if st.button('Calculate Risk'):
    ...
    probability, credit_score, rating = predicte(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,
                                                delinquency_ratio, credit_utilization_ratio, num_open_accounts,
                                                residence_type, loan_purpose, loan_type)
